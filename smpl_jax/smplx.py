...
class SMPLXModel(_SMPLBase):
    ...
    def _build_rotmats(self, params: SMPLXParams, B: int) -> jnp.ndarray:
        ...
        # Face joints (jaw, left-eye, right-eye)
        R_jaw   = jax.vmap(axis_angle_to_rotmat)(params.jaw_pose)[:, None]        # (B,1,3,3)
        R_leye  = jax.vmap(axis_angle_to_rotmat)(params.leye_pose)[:, None]       # (B,1,3,3)
